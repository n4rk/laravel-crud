...
<div class="container px-8">
    <h1 class="text-4xl font-bold my-8">Product :</h1>
    <form action="{{ route('products.show', $product->id) }}" class="flex flex-col space-y-6 px-4 md:px-20">
        <div class="w-full flex flex-col space-y-4">
            @method('GET')
            <div class="grid md:grid-cols-2 gap-8">
                <div class="flex justify-center items-center overflow-hidden">
                    <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image" class="object-cover w-full h-full rounded-2xl">
                </div>
                <div class="w-full h-full flex flex-col justify-between items-center bg-white p-6 rounded-lg shadow-lg">
                    <div class="space-y-8 md:pt-8">
                        <h1 class="text-3xl font-bold mb-2">{{ $product->name }}</h1>
                        <p class="text-gray-600 mb-4">{{ $product->description }}</p>
                        <div class="flex items-center justify-between mb-4">
                            <span class="text-2xl font-bold">${{ $product->price }}</span>
                            <span class="bg-green-500 text-white px-2 py-1 rounded-full text-sm">{{ $product->quantity }} in stock</span>
                        </div>
                        <div class="flex items-end gap-4">
                            <input type="number" min="1" max="15" value="1" class="w-20 p-2 border rounded">
        ...
        <h2 class="text-2xl font-medium italic mb-4">Customer Reviews</h2>
        <div class="space-y-4">
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <p class="text-gray-600">Excellent sound quality and comfortable for long use!</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="flex items-center justify-between mb-2">
                ...
                <p class="text-gray-600">Great headphones, but the battery life could be better.</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="flex items-center justify-between mb-2">
                    <span class="font-semibold">Mike R.</span>
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                ...
                <p class="text-gray-600">Best headphones I've ever owned. Worth every penny!</p>
            </div>
        </div>
    </form>
</div>
