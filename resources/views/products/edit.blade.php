...
<div class="container px-8">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" class="flex flex-col space-y-6 px-20">
        <div class="w-full flex flex-col space-y-4">
            ...
            <div class="w-full flex flex-col">
                ...
                <input id="image" type="file" name="image" class="py-2 px-4 rounded-lg border" value="{{ $product->image }}">
